...
public class HMS26 extends JFrame implements ActionListener
{
	JLabel l1;
	JTable jt1;
	JScrollPane jsp1;
	...
	public HMS26()
	{
		...
		ImageIcon i6=new ImageIcon("db view.PNG");  
		...
		JButton b5=new JButton("VIEW ALL APPT",i6);
	...
	public void actionPerformed(ActionEvent ae)
	{
		...
		if(s1.equals("VIEW ALL APPT"))
		{
			try
			{
				...
				PreparedStatement ps=co.prepareStatement("select * from appt_tbl");
				ResultSet rs=ps.executeQuery();
				String cols[]={"DOC_ID","DOC_NAME","DOC_DEPARTMENT","DOC_DUTY_DAYS","DOC_DUTY_TIME","DOC_PHONE_NO","APPT_ID","PAT_ID","PAT_NAME","PAT_SYMPTOMS","APPT_DATE","APPT_TIME","PAT_PHONE_NO","APPT_FEE"};
