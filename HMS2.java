...
public class HMS2 extends JFrame implements ActionListener
{
	String u1,p1;
	JTextField t1;
	JPasswordField t2;
	public HMS2()
	{
		...
		ImageIcon i1=new ImageIcon("adminpgbg1.JPG");   //bgpic
		...
		JLabel l4=new JLabel("       ADMIN LOGIN PANEL");
	...
	public void actionPerformed(ActionEvent ae)
	{
		...
		if(s1.equals("  Login"))
		{
			...
			try
			{
				...
				PreparedStatement ps=co.prepareStatement("select * from admin_tbl");						
				ResultSet rs = ps.executeQuery();
				int flg=0;
				while(rs.next())
				{	
					if(u1.equals(rs.getString(3)) && p1.equals(rs.getString(4)))
					{
