...
public class HMS8 extends JFrame implements ActionListener
{
	String u1,p1;
	JTextField t1;
	JPasswordField t2;
	public HMS8()
	{
		...
		ImageIcon i1=new ImageIcon("bg-8.JPG");   //bgpic
		...
		JLabel l4=new JLabel(" RECEPTIONIST LOGIN PANEL");
		...
		l4.setBounds(750,350,400,80);
		l5.setBounds(800,470,50,50);	//ulogo
		l6.setBounds(800,580,50,50);	//locklogo
		t1.setBounds(880,470,220,40);
		t2.setBounds(880,580,220,40);
		b1.setBounds(800,690,335,80);
		j1.setBounds(700,300,500,500);
	...
	public void actionPerformed(ActionEvent ae)
	{
		...
		if(s1.equals("  Login"))
		{
			...
			try
			{
				...
				while(rs.next())
				{
					if(u1.equals(rs.getString(9)) && p1.equals(rs.getString(10)))
					{
